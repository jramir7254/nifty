...
import MapLibreGL, { type PopupOptions, type MarkerOptions, GeolocateControl } from "maplibre-gl";
...
function MapControls({
    ...
    const handleResetBearing = useCallback(() => {
        ...
        // map?.resetNorthPitch({ duration: 300, essential: true, freezeElevation: true });

        map?.easeTo({
            bearing: 0,
            pitch: 0, // remove if you only want bearing reset
            duration: 300,
            essential: true,
        });
